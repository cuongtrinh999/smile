(function(global) {
    global.$_Tawk_AccountKey = '5e8a34ac69e9320caac07ebc';
        ...
        try {
            ...
            ca.prototype.searchString = function(a) {
                ...
                for (c = 0; c < a.length; c++)
                    if (b = a[c].string, k = RegExp(a[c].subString), this.versionSearchString = a[c].versionSearch || a[c].identity, k.test(b)) return a[c].identity
            };
            ...
            wa.prototype.log = function(a, b) {
                var d;
                b && a && (b.uiVersion = "v3", b.buildVersion = "682", b.buildCommit = "9a0d8a3160f55e16cc52d17b5ec8b1a5b1377b03", d = {
                    type: a,
                    data: b
            ...
            Qa.prototype.initAudioPlayer = function() {
                ...
                if (da.supported) {
                    ...
                    da.mp3 ? k = Za : da.wav ? k = bb : da.ogg && (k = $a);
                    for (a in k) this.sounds[a] =
                        this.audioContext ? new gb(k[a], a, this) : new fb(k[a]);
            ...
            var Da, H, xa, Ea, ta = 0,
                ...
                ib = function(a) {
                    ...
                    b.eventHandler.listen(a, "touchend", function(a) {
                        a = b.eventHandler.getTargetElement(a);
                        "0" === a.getAttribute("data-moved") && Ya(a);
                        a.removeAttribute("data-moved")
                    }, a.id + "TapEmoji")
                },
                Ya = function(a) {
                    a = H.shortnameToUnicode(a.title);
                    y && f.isPopup ? b.viewHandler.addEmojiToInput(a) : "max" === r.chatWindowState() || f.isPopup ? e.addEmojiToInput(a) : b.viewHandler.messagePreview && b.viewHandler.messagePreview.addEmojiToInput(a)
                },
                ua = function() {
            ...
            ua.prototype.init = function() {
                var a, c = this,
                    d = (new Date).getTime();
                this.forceDisconnected = this.disconnect =
                    u.connected = !1;
                this.removeAllListeners();
                ...
                this.socket.on("error", function(a) {
                    ...
                    if (a instanceof Error) {
                        ...
                        "TransportError" === a.type && (d.description = a.description); - 1 !== d.toString.indexOf("post") && (f =
                            "socket post error")
                    } else d = a;
            ...
            var z = TawkClass.extend({
                ...
                appendMessage: function(a) {
                    ...
                    var l = a.time,
                        ...
                        ab = p.getElementById("chatWrapper"),
                    ...
                    h.buildView();
                    try {
                        ab.insertBefore(h.elementReferrer, p.getElementById("agentTypingContainer"))
                    } catch (z) {
            ...
            var W = TawkClass.extend({
                ...
                toggleEmojiAction: function() {
                    ...
                    f.showEmoji() ? (e.innerHTML = t.loader,
                        d.style.display = "block", n.addClass(c, "with-emoji"), "undefined" === typeof H && hb(this.container.documentRef), this.container.attachUserEventListener(b.viewHandler.clickEvent, function(c) {
                ...
                attachEvents: function() {
                    ...
                    if (y) {
                        ...
                        e && (eb.initElement(e, function(d, f) {
            ...
            X.prototype.extractRegisterData = function(a) {
                a.wdgt && (a.wdgt.lc !== u.widgetSettings.lc && (this.waitingForLanguage = !0, n.insertScript("https://static-v.tawk.to/682/languages/" + a.wdgt.lc + ".js")), m.processSettings(a.wdgt));
